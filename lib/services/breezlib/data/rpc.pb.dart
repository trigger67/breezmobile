...
class LNUrlPayMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LNUrlPayMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'data'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'longDescription')
    ..aOM<LNUrlPayImage>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'image', subBuilder: LNUrlPayImage.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set longDescription($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasLongDescription() => $_has(1);
  @$pb.TagNumber(2)
  void clearLongDescription() => clearField(2);

  @$pb.TagNumber(3)
  LNUrlPayImage get image => $_getN(2);
  @$pb.TagNumber(3)
  set image(LNUrlPayImage v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasImage() => $_has(2);
  @$pb.TagNumber(3)
  void clearImage() => clearField(3);
  @$pb.TagNumber(3)
  LNUrlPayImage ensureImage() => $_ensure(2);
}
